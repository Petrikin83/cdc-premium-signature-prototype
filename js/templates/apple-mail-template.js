...
<table width="620" cellpadding="0" cellspacing="0" border="0" bgcolor="#ffffff"
  ...
  <!-- Column widths: 116 + 18 + 259 + 1 + 14 + 212 = 620 px -->
  <tr>

    <!-- CDC badge logo — 116 px -->
    <td width="116" valign="middle" bgcolor="#ffffff"
        style="background-color: #ffffff; padding: 14px 0 14px 0; vertical-align: middle;">
      <img src="${CDC_CONFIG.assets.logo}"
           width="116"
           alt="CDC"
           style="display: block; border: 0; height: auto; width: 116px;">
    </td>
    ...
    <!-- Vertical separator — floating 68 px line, vertically centered -->
    <td width="1" valign="middle" bgcolor="#ffffff"
      ...
      <table width="1" cellpadding="0" cellspacing="0" border="0"
        ...
        <tr>
          <td width="1" height="68" bgcolor="#eeeeee"
              style="background-color: #eeeeee; font-size: 0; line-height: 0;
                     width: 1px; height: 68px;"></td>
        </tr>
      </table>
    </td>
      ...
      <table width="100%" cellpadding="0" cellspacing="0" border="0"
        ...
        <tr>
          ...
          <td valign="middle" bgcolor="#ffffff"
              style="background-color: #ffffff; padding: 0 15px 0 0; vertical-align: middle; white-space: nowrap;">
          ...
          <!-- Pipe -->
          <td width="1" bgcolor="#d0d0d0"
              style="background-color: #d0d0d0; font-size: 0; line-height: 0; padding: 0;"></td>

          <!-- Email -->
          <td valign="middle" bgcolor="#ffffff"
              style="background-color: #ffffff; padding: 0 15px; vertical-align: middle; white-space: nowrap;">
          ...
          <!-- Website -->
          <td valign="middle" bgcolor="#ffffff"
              style="background-color: #ffffff; padding: 0 0 0 15px; vertical-align: middle; white-space: nowrap;">
